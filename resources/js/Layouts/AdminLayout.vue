...
const NAV = [
    ...
    { href: '/admin/orders', label: 'Pesanan', icon: 'M6 3h12v18l-3-2-3 2-3-2-3 2zM9 8h6M9 12h6' },
    { href: '/admin/coupons', label: 'Kupon', icon: 'M4 7h16v4a2 2 0 0 0 0 4v2H4v-2a2 2 0 0 0 0-4zM10 7v10' },
    { href: '/admin/feedback', label: 'Saran', icon: 'M4 5h16v11H8l-4 4z' },
